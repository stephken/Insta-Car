...
from insta_post.views import IndexView, post_form_view, comment_form_view, photo_detail, up_vote, down_vote, del_post, post_edit_view, del_comment, edit_comment
